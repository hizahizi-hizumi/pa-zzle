...
- rule 本体で完結すべき規約・手順を `dev/docs/` や他 rule に逃がしていない
- `dev/docs/` の正本データ・仕様・語彙を参照する場合、正本パスと Read が必要なタイミングが明示されている
...
- rule 本体で定義すべき規約・手順を `dev/docs/` に逃がし、「詳細は docs を参照」だけで済ませている
