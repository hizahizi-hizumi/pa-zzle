...
const snapshot: FifteenPuzzleDiagnosticSnapshot = {
  formatVersion: 1,
  game: "fifteen-puzzle",
  difficulty: "3",
  problemIdentity: {
...
describe("FifteenPuzzleDiagnostics", () => {
  beforeEach(() => {
    render(<FifteenPuzzleDiagnostics snapshot={snapshot} onClose={vi.fn()} />);
  });

  test("15パズル固有の診断値を共通ダイアログへ表示すること", () => {
