...
import { SUDOKU_DIGITS, type SudokuDigit } from "@/games/sudoku/game/state";
import { cn } from "@/lib/utils";

type SudokuInputPanelProps = {
  notesMode: boolean;
  ...
  onInputDigit: (digit: SudokuDigit) => void;
};

export function SudokuInputPanel({
  notesMode,
  interactionEnabled,
  selectedIsEditable,
  selectedHasAnswer,
